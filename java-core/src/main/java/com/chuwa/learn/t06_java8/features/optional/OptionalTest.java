package com.chuwa.learn.t06_java8.features.optional;
...
class OptionalTest {
    ...
    private static NoSuchElementException createException() {
    ...
    void testOrElseThrow() {
        ...
        assertThrows(NoSuchElementException.class, () -> optional.orElseThrow(OptionalTest::createException));
    }
