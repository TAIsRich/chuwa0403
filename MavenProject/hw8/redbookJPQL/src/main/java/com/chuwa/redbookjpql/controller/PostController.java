package com.chuwa.redbookjpql.controller;
...
public class PostController {
    ...
    public ResponseEntity getPostByIdOrTitleJPQLIndex(@PathVariable("id") long id,
   ...
   @PutMapping
    public ResponseEntity updatePost(@RequestBody PostDto postDto, @PathVariable(name = "id") long id){
