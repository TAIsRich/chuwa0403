package com.chuwa.learn.c02_basic_thread_handling;

import com.chuwa.learn.c01_create.MyThread;
...
public class Daemon {
    public static void main(String[] args) {
        ...
        tGod2.start(); // 只剩下守护进程时候，哪怕有多个，jvm也会退出
