...
public class ApiTest2 {
    private static final Logger LOGGER = Logger.getLogger(ApiTest2.class.getName());
    ...
    public static void main(String[] args) {
        CompletableFuture<String> productsFuture = CompletableFuture.supplyAsync(() -> {
            try {
                ...
                return "{ \"products\": [] }"; // Default Value when error occurred
            }
        });
        ...
        CompletableFuture<String> reviewsFuture = CompletableFuture.supplyAsync(() -> {
            try {
                ...
                return "{ \"reviews\": [] }"; // Default Value when error occurred
            }
        });
        ...
        CompletableFuture<String> inventoryFuture = CompletableFuture.supplyAsync(() -> {
            try {
                ...
                return "{ \"inventory\": [] }"; // Default Value when error occurred
            }
        });
