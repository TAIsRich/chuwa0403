...
public class CommentServiceImplTest {
    ...
    void setUp() {
        logger.info("start");
        this.post = new Post(6L, "", "", "", LocalDateTime.now(), LocalDateTime.now());
        this.comment = new Comment(2L,"","","");
    ...
    public void testGetCommentsByPostId(){
        Mockito.when(commentRepositoryMock.findByPostId(ArgumentMatchers.any(Long.class))).thenReturn(commentList);
    ...
    public void testGetCommentById(){
        Mockito.when(commentRepositoryMock.findById(ArgumentMatchers.any(Long.class))).thenReturn(Optional.of(comment));
        Mockito.when(postRepositoryMock.findById(ArgumentMatchers.any(Long.class))).thenReturn(Optional.of(post));
    ...
    public void testGetCommentById_CommentNotBelong(){
        Post tempPost = new Post(7L, "", "", "", LocalDateTime.now(), LocalDateTime.now());
        Mockito.when(commentRepositoryMock.findById(ArgumentMatchers.any(Long.class))).thenReturn(Optional.of(comment));
        Mockito.when(postRepositoryMock.findById(ArgumentMatchers.any(Long.class))).thenReturn(Optional.of(tempPost));
