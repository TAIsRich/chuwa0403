...
```
   ...
   1. singleton (default): A single instance of the bean is created for the entire lifetime of the application context.
   2. request: A new instance of the bean is created for each HTTP request that is handled by a Spring MVC controller.
   3. session: A new instance of the bean is created for each HTTP session that is started by a user.
   4. application: A single instance of the bean is created for the entire lifetime of the ServletContext.
   5. websocket: A new instance of the bean is created for each WebSocket session that is established between a client and server.
