...
A servlet is a Java programming language class that is used to extend the capabilities of servers that host applications accessed by means of a request-response programming model. 其主要功能在于交互式地浏览和修改数据，生成动态 Web 内容。
...
See [here](./../Coding/hw9/springmvc5-demo-main).
